...
<div class="bg-white rounded-lg shadow-md">
    <div class="p-6 border-b border-gray-200">
        <h3 class="text-lg font-semibold mb-4">Form Tambah Dosen | <span id="progressText" class="text-green-600">0% Selesai</span></h3>
        <!-- Progress Bar -->
    ...
    <form action="{{ route('admin.dosen.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            ...
            <div class="flex gap-6">
                ...
                <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="nama_dosen" value="{{ old('nama_dosen') }}" required data-section="pribadi"
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" placeholder="-" data-section="pribadi"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                </div>
            </div>
        ...
        <div class="bg-gray-50 rounded-lg p-6 mb-6 border border-gray-200">
            ...
            <div>
                ...
                <input type="date" name="tmt_cpns_ppk" value="{{ old('tmt_cpns_ppk') }}" placeholder="-" data-section="pekerjaan"
            ...
            <div>
                ...
                <select name="golongan" data-section="pekerjaan"
                    ...
                    @foreach($golongans as $golongan)
                        <option value="{{ $golongan->nama }}" {{ old('golongan') == $golongan->nama ? 'selected' : '' }}>
                            {{ $golongan->nama }}
                        </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <input type="date" name="tmt" value="{{ old('tmt') }}" placeholder="-" data-section="pekerjaan"
            ...
            <div>
                ...
                <select name="jf" data-section="pekerjaan"
                    ...
                    <option value="TP" {{ old('jf') == 'TP' ? 'selected' : '' }}>TP (Tenaga Pengajar)</option>
                    <option value="L" {{ old('jf') == 'L' ? 'selected' : '' }}>L (Lektor)</option>
                    <option value="AA" {{ old('jf') == 'AA' ? 'selected' : '' }}>AA (Asisten Ahli)</option>
                </select>
                @error('jf')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <input type="date" name="tmt_jf" value="{{ old('tmt_jf') }}" placeholder="-" data-section="pekerjaan"
            ...
            <div>
                ...
                <input type="text" name="nuptk" value="{{ old('nuptk') }}" data-section="pekerjaan"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
            </div>
