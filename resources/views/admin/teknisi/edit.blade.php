...
@section('header', 'Edit Teknisi')

@section('content')
<div class="bg-white rounded-lg shadow-md">
    <div class="p-6 border-b border-gray-200">
        <h3 class="text-lg font-semibold mb-4">Form Edit Teknisi | <span id="progressText" class="text-purple-600">0% Selesai</span></h3>
        <!-- Progress Bar -->
    ...
    <form action="{{ route('admin.teknisi.update', $teknisi) }}" method="POST" enctype="multipart/form-data" class="p-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-gray-50 rounded-lg p-6 mb-6 border border-gray-200">
            ...
            <div class="flex gap-6">
                ...
                <div class="flex-shrink-0">
                    <div id="fotoPreview" class="{{ $teknisi->foto ? '' : 'hidden' }} mb-4">
                        <img id="previewImage" src="{{ $teknisi->foto ? asset('storage/' . $teknisi->foto) : '' }}" alt="Preview" class="w-48 h-48 object-cover rounded-lg shadow-md">
                    </div>
                ...
                <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <input type="text" name="nama" value="{{ old('nama', $teknisi->nama) }}" required data-section="pribadi"
                ...
                <div>
                    ...
                    <input type="text" name="nip" value="{{ old('nip', $teknisi->nip) }}" data-section="pribadi"
                ...
                <div>
                    ...
                    <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir', $teknisi->tempat_lahir) }}" data-section="pribadi"
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir', $teknisi->tanggal_lahir ? $teknisi->tanggal_lahir->format('Y-m-d') : '') }}" data-section="pribadi"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
                </div>
                </div>
            </div>
        ...
        <div class="bg-gray-50 rounded-lg p-6 mb-6 border border-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="unit_kerja" value="{{ old('unit_kerja', $teknisi->unit_kerja) }}" data-section="pekerjaan"
                ...
                <div>
                    ...
                    <input type="date" name="tmt_cpns_ppk" value="{{ old('tmt_cpns_ppk', $teknisi->tmt_cpns_ppk) }}" data-section="pekerjaan"
                ...
                <div>
                    ...
                    <select name="status_kepegawaian" data-section="pekerjaan"
                        ...
                        <option value="CPNS" {{ old('status_kepegawaian', $teknisi->status_kepegawaian) == 'CPNS' ? 'selected' : '' }}>CPNS</option>
                        <option value="PNS" {{ old('status_kepegawaian', $teknisi->status_kepegawaian) == 'PNS' ? 'selected' : '' }}>PNS</option>
                        <option value="PPPK" {{ old('status_kepegawaian', $teknisi->status_kepegawaian) == 'PPPK' ? 'selected' : '' }}>PPPK</option>
                        <option value="PPPK New" {{ old('status_kepegawaian', $teknisi->status_kepegawaian) == 'PPPK New' ? 'selected' : '' }}>PPPK New</option>
                        <option value="PPPK Paruh Waktu" {{ old('status_kepegawaian', $teknisi->status_kepegawaian) == 'PPPK Paruh Waktu' ? 'selected' : '' }}>PPPK Paruh Waktu</option>
                        <option value="Honorer" {{ old('status_kepegawaian', $teknisi->status_kepegawaian) == 'Honorer' ? 'selected' : '' }}>Honorer</option>
                        <option value="THL" {{ old('status_kepegawaian', $teknisi->status_kepegawaian) == 'THL' ? 'selected' : '' }}>THL</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="text" name="pendidikan_terakhir" value="{{ old('pendidikan_terakhir', $teknisi->pendidikan_terakhir) }}" data-section="pekerjaan"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="tahun_lulus" value="{{ old('tahun_lulus', $teknisi->tahun_lulus) }}" data-section="pekerjaan"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
                </div>
                ...
                <div>
                    ...
                    <select name="pangkat" data-section="pekerjaan"
                        ...
                        @foreach($pangkats as $pangkat)
                            <option value="{{ $pangkat->nama }}" {{ old('pangkat', $teknisi->pangkat) == $pangkat->nama ? 'selected' : '' }}>
                                {{ $pangkat->nama }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="gol" data-section="pekerjaan"
                        ...
                        @foreach($golongans as $golongan)
                            <option value="{{ $golongan->nama }}" {{ old('gol', $teknisi->gol) == $golongan->nama ? 'selected' : '' }}>
                                {{ $golongan->nama }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="date" name="tmt_gol" value="{{ old('tmt_gol', $teknisi->tmt_gol) }}" placeholder="-" data-section="pekerjaan"
                ...
                <div>
                    ...
                    <select name="kelas_jabatan" data-section="pekerjaan"
                        ...
                        <option value="">-</option>
                        <option value="1" {{ old('kelas_jabatan', $teknisi->kelas_jabatan) == '1' ? 'selected' : '' }}>1</option>
                        <option value="3" {{ old('kelas_jabatan', $teknisi->kelas_jabatan) == '3' ? 'selected' : '' }}>3</option>
                        <option value="5" {{ old('kelas_jabatan', $teknisi->kelas_jabatan) == '5' ? 'selected' : '' }}>5</option>
                        <option value="6" {{ old('kelas_jabatan', $teknisi->kelas_jabatan) == '6' ? 'selected' : '' }}>6</option>
                        <option value="7" {{ old('kelas_jabatan', $teknisi->kelas_jabatan) == '7' ? 'selected' : '' }}>7</option>
                        <option value="8" {{ old('kelas_jabatan', $teknisi->kelas_jabatan) == '8' ? 'selected' : '' }}>8</option>
                        <option value="9" {{ old('kelas_jabatan', $teknisi->kelas_jabatan) == '9' ? 'selected' : '' }}>9</option>
                        <option value="12" {{ old('kelas_jabatan', $teknisi->kelas_jabatan) == '12' ? 'selected' : '' }}>12</option>
                    </select>
                    @error('kelas_jabatan')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="date" name="tahun_purna_tugas" value="{{ old('tahun_purna_tugas', $teknisi->tahun_purna_tugas) }}" placeholder="-" data-section="pekerjaan"
...
function updateProgress() {
    ...
    pribadiFields.forEach(field => {
        if (field.type === 'file') {
            // Check if file is selected or if there's existing foto
            const hasFile = field.files.length > 0;
            const hasExisting = document.getElementById('previewImage').src && 
                              document.getElementById('previewImage').src !== window.location.href;
            if (hasFile || hasExisting) pribadiCount++;
