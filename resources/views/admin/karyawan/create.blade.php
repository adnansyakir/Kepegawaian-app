...
<div class="bg-white rounded-lg shadow-md">
    <div class="p-6 border-b border-gray-200">
        <h3 class="text-lg font-semibold mb-4">Form Tambah Karyawan | <span id="progressText" class="text-blue-600">0% Selesai</span></h3>
        <!-- Progress Bar -->
    ...
    <form action="{{ route('admin.karyawan.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            ...
            <div class="flex gap-6">
                ...
                <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nip" value="{{ old('nip') }}" required data-section="pribadi"
        ...
        <div class="bg-gray-50 rounded-lg p-6 mb-6 border border-gray-200">
            ...
            <div>
                ...
                <select name="unit_kerja" data-section="pekerjaan"
                    ...
                    @foreach($unitKerjas as $unitKerja)
                        <option value="{{ $unitKerja->nama }}" {{ old('unit_kerja') == $unitKerja->nama ? 'selected' : '' }}>
                            {{ $unitKerja->nama }}
                        </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <input type="text" name="penempatan_kerja" value="{{ old('penempatan_kerja') }}" data-section="pekerjaan"
            ...
            <div>
                ...
                <input type="date" name="tmt_pns_p3k" value="{{ old('tmt_pns_p3k') }}" data-section="pekerjaan"
